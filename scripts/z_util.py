...
def store_pairs_on_sky(catalogue, max_separation=15.0, min_separation=0.0,
    ...
    np.savetxt(save_location + all_pairs_name, all_pairs, delimiter=',')
    np.savetxt(save_location + random_pairs_name, random_pairs, delimiter=',')
...
def read_pairs(IDs, pair_location):
    """Uses existing pair data files to quickly find pairs within specified categories."""
